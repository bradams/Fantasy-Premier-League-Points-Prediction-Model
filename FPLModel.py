...
trainData = gameweekData[gameweekData['gameweek'].isin([1,2,3,4])]
...
prevWeeksAvgATK = aggregatePrevGameweeks(3,4, trainDataATK, statsToAvgATK)
prevWeeksAvgMID = aggregatePrevGameweeks(3,4, trainDataMID, statsToAvgATK)
prevWeeksAvgDEF = aggregatePrevGameweeks(3,4, trainDataDEF, statsToAvgDEF)
prevWeeksAvgGK = aggregatePrevGameweeks(3,4, trainDataGK, statsToAvgGK)

#train model on x weeks of data
trainDataATK = trainDataATK[trainDataATK['gameweek'].isin([1,2])]
trainDataMID = trainDataMID[trainDataMID['gameweek'].isin([1,2])]
trainDataDEF = trainDataDEF[trainDataDEF['gameweek'].isin([1,2])]
trainDataGK = trainDataGK[trainDataGK['gameweek'].isin([1,2])]
...
makePredictions(xTrL, yTrL, xTeL, yTeL, playerIDs, Ridge(alpha = 0.1), nameList)
